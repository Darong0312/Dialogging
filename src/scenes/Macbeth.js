class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.first_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch_1').setOrigin(0, 1);
        this.second_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch_3').setOrigin(0, 1);
        this.third_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch_3').setOrigin(0, 1);
        this.all_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch_1').setOrigin(0, 1);
